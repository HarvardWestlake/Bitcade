...
const HorseRacingGameComponent = ({ contractAddress }) => {
  ...
  const [newHorseName, setNewHorseName] = useState(''); // State to hold the name of the new horse
        ...
        <>
          {!raceStarted ? (
            <>
              ...
              />
              <button onClick={addNewHorse} disabled={loading}>
                Add Horse
              </button>
