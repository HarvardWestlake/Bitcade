...
import RacingGame from './games/RacingGameUI'; // Import the game component
import RockPaperScissors from './games/RockPaperScissors';

// Update the contract address here
const exampleContractAddress = '0x51C72848c68a965f66FA7a88855F9f7784502a7F';
const racingGameAddress = '0x51C72848c68a965f66FA7a88855F9f7784502a7F';
      ...
      <div className='App'>
        ...
        <div className='content'>
          ...
          <div className='main-panel' style={{ flex: '70%' }}>
            ...
            <RacingGame contractAddress={racingGameAddress} />
          </div>
          <div className='side-panel' style={{ flex: '15%' }}></div>
        </div>
      </div>
